...
final class Assets
{
    ...
    protected function injectDefaultFiles($stream) : void
    {
        ...
        if (\Flames\Forge\Cli\Command\Build\Assets\Template::isTemplateExtension() === true) {
...
';
    ...
    protected function mountVirtualDefaultFiles($virtualFilesBuffer)
    {
        ...
        if (\Flames\Forge\Cli\Command\Build\Assets\Template::isTemplateExtension() === true) {
            $defaultFiles = \Flames\Forge\Cli\Command\Build\Assets\Template::injectDefaultFiles($defaultFiles);
            $clientMocks = \Flames\Forge\Cli\Command\Build\Assets\Template::injectClientMocks($clientMocks);
        }
    ...
    {
        $useViews = \Flames\Forge\Cli\Command\Build\Assets\Template::isTemplateExtension();
